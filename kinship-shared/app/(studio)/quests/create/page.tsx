        ...
        action={
          <div className="flex gap-3">
            ...
            <button
              ...
              className="btn bg-accent hover:bg-accent-dark text-white border-0 rounded-xl font-bold px-5 py-2.5 disabled:opacity-50"
            >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-input border border-card-border rounded-xl px-4 py-3 text-foreground text-sm placeholder:text-muted focus:outline-none focus:border-accent/50 resize-none"
                  />
                </div>
                <div>
                  <label className="text-white/70 text-sm block mb-2">
