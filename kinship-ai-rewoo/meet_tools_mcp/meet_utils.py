"""
Common utility functions for Google Meet MCP tools.
"""
...
def check_send_permission(
    ...
    """
    Check if the user has permission to perform write operations (create Meet, add to event, etc.).
    
    Rules:
    - If wallet == creator_wallet: FULL ACCESS
    - If wallet != creator_wallet: Can ONLY create meets with creator
